    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.analyseBtn}>
          <Button onPress={this._getUserInformation} title="Analyze" />
        </View>

        <View>{this._displayProgressBar(

          <Image
            style={{ flex:1, height: 350, marginLeft: 10, marginRight: 10 }}
...
async function getInformation() {
  ...
  let apiUrl = 'http://10.0.0.5:8080/users';
...
async function getNearbyHospitals() {
  ...
  let apiUrl = 'http://10.0.0.5:8080/eye/hospitals';
...
async function getDiseaseStatus() {
  ...
  let apiUrl = 'http://10.0.0.5:8080/eye';
